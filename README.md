...
```
public/images/
├── hero/hero-bg.png            ← ภาพหัวเว็บ         (1983 × 793)
├── services/service-01.png     ← การ์ดบริการใบที่ 1  (800 × 520)
│            service-02.png     ← การ์ดบริการใบที่ 2
│            service-03.png     ← การ์ดบริการใบที่ 3
├── portfolio/portfolio-01.png  ← ผลงานชิ้นที่ 1     (1000 × 700)
│            … ถึง portfolio-06.png
├── about/about-main.png        ← ภาพ "เกี่ยวกับเรา"  (900 × 620)
├── cta/cta-bg.png              ← พื้นหลังแถบ CTA     (1600 × 440)
├── contact/line-qr.png         ← QR Code แอดไลน์     (376 × 376)
...
// data/images.ts
hero: {
  src: "/images/hero/hero-bg.png",   // ← เปลี่ยนตรงนี้
  alt: "วัฒน์จัดให้ มากกว่าบริการ คือคู่คิด",
  width: 1983,                       // ← ใส่ขนาดจริงของรูป
  height: 793,
},
```
...
- ภาพ Hero เป็น **แบนเนอร์ที่มีตัวหนังสือฝังมาในรูปแล้ว** เว็บจึงไม่วางข้อความทับ
  ถ้าเปลี่ยนเป็นรูปที่ไม่มีตัวหนังสือ บอกได้ ผมย้ายข้อความกลับมาเป็น HTML ให้
