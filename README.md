...
| แท็บ | แก้อะไรได้ |
| ---- | ---------- |
| **ข้อมูลเว็บไซต์** | ชื่อแบรนด์ · สโลแกน · **โลโก้** · เบอร์โทร · LINE · เวลาทำการ · โซเชียล · เมนู |
...
├── logo/                        ← โลโก้ (อัปโหลดผ่านหลังบ้าน)
...
| โลโก้ | [`content/images.json`](content/images.json) | `logo` · `logoDark` |
...
- แบนเนอร์ Hero แสดงเต็มใบทุกขนาดหน้าจอ ไม่มีการครอป
